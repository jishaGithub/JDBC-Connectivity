...
public class BranchLocationDAO extends AbstractDAO implements GenericDAO<BranchLocation> {
    private static final Logger logger = LogManager.getLogger(BranchLocationDAO.class);
