...
public class MySQLVehicleDAO extends AbstractDAO<Vehicle> {
    private static final Logger logger = LogManager.getLogger(MySQLVehicleDAO.class);
    ...
    public Vehicle get(int id) {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(GET_BY_ID)) {
            ...
            if (result.next()) {
                ...
                return new Vehicle(vehicleId, brand, model, year, color, mileage, licenseNumber, categoryId, customerId);
            } else {
