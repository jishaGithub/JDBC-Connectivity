...
public class VehicleCategoryDAO extends AbstractDAO implements GenericDAO<VehicleCategory> {
    private static final Logger logger = LogManager.getLogger(VehicleCategoryDAO.class);
