...
public class VehicleFeatureDAO extends AbstractDAO implements GenericDAO<VehicleFeature> {
    private static final Logger logger = LogManager.getLogger(VehicleFeatureDAO.class);
