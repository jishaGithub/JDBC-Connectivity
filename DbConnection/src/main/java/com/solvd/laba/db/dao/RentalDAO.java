...
public class RentalDAO extends AbstractDAO implements GenericDAO<Rental> {
    private static final Logger logger = LogManager.getLogger(RentalDAO.class);
    ...
    public Rental get(int id) {
        ...
        try (PreparedStatement preparedStatement = getConnection().prepareStatement(GET_BY_ID)) {
            ...
            if (result.next()) {
                ...
                Rental rental = new Rental(rentalId, rentalDate, returnDate, customerId, insuranceId, rentalRateId, vehicleId, promotionId, employeeId);
